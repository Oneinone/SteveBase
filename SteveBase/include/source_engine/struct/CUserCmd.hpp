...
#include <source_engine/def/AttackButtonState.hpp>
...
namespace SteveBase::SourceEngine::Structure {
    ...
    struct CUserCmd {
    private:
        virtual			  ~CUserCmd() {};   // 0x00 Virtual Destructor
        ...
        float			  sidemove;			// 0x28
        float			  upmove;			// 0x2C
        AttackButtonState buttons;			// 0x30 Attack button states
        char			  impulse;			// 0x34
    ...
    public:
        ...
        AttackButtonState &GetAttackButtonStateRef() {
            return buttons;
        }
